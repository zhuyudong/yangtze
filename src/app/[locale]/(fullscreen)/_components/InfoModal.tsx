...
export const InfoModal: FC<InfoModalProps> = ({ visible, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black opacity-80 transition duration-300">
      <div className="relative mx-auto w-auto max-w-3xl overflow-hidden rounded-md">
        ...
        >
          <div className="relative h-96">
            ...
            <div
              onClick={handleClose}
              className="absolute right-3 top-3 flex size-10 cursor-pointer items-center justify-center rounded-full bg-black opacity-70"
            >
