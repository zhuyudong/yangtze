...
一个开源分布式对象存储，AWS S3 的替代品，兼容 S3 的客户端，可以建立自己的网络存储系统。类似还有 [SeaweedFS](https://github.com/seaweedfs/seaweedfs)。
...
[StarLocator](https://github.com/BengbuGuards/StarLocator)
...
[HotHub](https://github.com/w4n9hu1/hot-hub-web)
...
[RSS Impact](https://github.com/CaoMeiYouRen/rss-impact-server)

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024102913.webp)

一个开源的 RSS 在线订阅，支持各种机制的 Hook（网络钩子），可以用来触发各种操作。（[@CaoMeiYouRen](https://github.com/ruanyf/weekly/issues/5418) 投稿）

[codess](https://codess.dumogu.top/) 
...
一个基于浏览器的数据库管理，支持 Postgres、MySQL、SQLite、MongoDB、 Redis。

[Docmost](https://github.com/docmost/docmost)

![](https://cdn.beekka.com/blogimg/asset/202407/bg2024071112.webp)

一个基于浏览器的维基和文档，Confluence 和 Notion 替代品。

[notifier](https://github.com/byodian/notifier)
...
开源的微信公众号文章在线导出，可用来批量下载某个公众号的文章。（[@jooooock](https://github.com/ruanyf/weekly/issues/5387) 投稿）
...
[加水印](https://github.com/pdmaker/watermark-master)

![](https://cdn.beekka.com/blogimg/asset/202410/bg2024102206.webp)

图片加水印的网页，纯前端应用，不需要服务器，代码开源。（[@pdmaker](https://github.com/ruanyf/weekly/issues/5395) 投稿）
...
在 Chrome 开发者中查看安卓设备的 adb 日志。（[@nieheyong](https://github.com/ruanyf/weekly/issues/5326) 投稿）
...
[vitepress-demo-plugin](https://github.com/zh-lx/vitepress-demo-plugin)
...
[notion2md](https://github.com/thinkerchan/notion2md)
...
macOS 系统的剪贴板替代，防止第三方应用程序访问剪贴板。（[@s1ntoneli](https://github.com/ruanyf/weekly/issues/5238) 投稿）

[词悦（Ciyue）](https://github.com/mumu-lhl/Ciyue)
...
[独白](https://apps.apple.com/app/id6648770338)
...
[photo4you.win](https://photo4you.win/)
...
[联网麻将游戏](https://github.com/liumengniu/majiang)

麻将游戏的一个开源实现，分成服务端和客户端。（[@liumengniu](https://github.com/ruanyf/weekly/issues/5247) 投稿）

[X Guard](https://chromewebstore.google.com/detail/x-guard/lljdlddjpnlabinhkgmhmnfacgjkggim)
...
[Weather as Landscape](https://github.com/lds133/weather_landscape)
...
[玉竹（Yuzhu）](https://github.com/hefengbao/yuzhu)
...
[IPFS telegra.ph](https://github.com/chenjia404/ipfs-telegra.ph)

一个在 ipfs 上写文章的极简发布，从网页输入文章发布到 ipfs。（[@chenjia404](https://github.com/ruanyf/weekly/issues/5176) 投稿）
...
一个 JS 库，生成 V8 格式和 Istanbul 格式的测试覆盖报告。（[@cenfun](https://github.com/ruanyf/weekly/issues/5190) 投稿）

[五子棋人机对战](https://github.com/mumuy/gobang)
...
开源的 JSON 数据的在线可视化、处理。（[@loggerhead](https://github.com/ruanyf/weekly/issues/5192) 投稿）

[Compress JPG](https://compressjpg.io/)
...
一个自动总结提交信息，生成 changelog 文件的命令行。
...
[Xnapper](https://xnapper.com/app)

![](https://cdn.beekka.com/blogimg/asset/202409/bg2024091703.webp)

一个截图美化的在线，可以为截图加各种边框。

[sisi](https://github.com/frost-beta/sisi)

命令行的图像语义搜索，让你用自然语言搜索本地图像。
...
一个开源的 Windows 快捷启动，分门别类管理桌面快捷方式。（[@fanchenio](https://github.com/ruanyf/weekly/issues/5157) 投稿）
...
[SimpleMockServer](https://github.com/couriourc/mock_server)
...
一个开源，提供一个 Web 界面，浏览和操作本地文件。（[@xiaobaidadada](https://github.com/ruanyf/weekly/issues/5133) 投稿）
...
[XDeck](https://github.com/morishin/XDeck)
...
[Unforget](https://github.com/computing-den/unforget)
...
这个开源从 DNS 提供商，自动获取域名的解析列表，用来检查所有域名（含二级域名）的证书是否过期，目前支持腾讯云、阿里云和 Godaddy。（[@eryajf](https://github.com/ruanyf/weekly/issues/5098) 投稿）
...
[ThinNav](https://github.com/DemoJ/ThinNav)
...
一个在线，用来生成符合指定格式的 JSON 伪数据。

[LangSync](https://langsync.app/)

![](https://cdn.beekka.com/blogimg/asset/202310/bg2023100501.webp)

一个命令行，使用 AI 一键翻译出软件的语言包。

[ttyd](https://github.com/tsl0922/ttyd)

这个命令行可以在浏览器里面，打开本机的终端窗口，让用户在浏览器执行终端命令。
...
[电池的电量显示](https://deepesh-01.github.io/battery_indicator/)
...
[tsimp](https://github.com/tapjs/tsimp)
...
[奇异字体生成器](https://freakyfontgenerator.top/)（Freaky Font Generator）

![](https://cdn.beekka.com/blogimg/asset/202408/bg2024082001.webp)

一款在线，通过 Unicode 编码转换，生成各种效果的文字变体（比如斜体、黑体、带圈字符），不支持中文字符。（[@wincatcher](https://github.com/ruanyf/weekly/issues/5033) 投稿）
...
一个快速生成落地页的，可以选择落地页的常见模块。（[@ObservedObserver](https://github.com/ruanyf/weekly/issues/4956) 投稿）

[Porn Logo Maker](https://porn-logo.com/)

![](https://cdn.beekka.com/blogimg/asset/202408/bg2024081102.webp)

定制拼色 Logo 的在线。（[@ychrisp](https://github.com/ruanyf/weekly/issues/4968) 投稿）
...
内网穿透 frp 的跨平台桌面客户端。（[@forestxieCode](https://github.com/ruanyf/weekly/issues/4982) 投稿）

[NotchDrop](https://github.com/Lakr233/NotchDrop/)

![](https://cdn.beekka.com/blogimg/asset/202408/bg2024081412.webp)

一个开源，将 MacBook 刘海变成一个文件传输和暂存区域。（[@wangyuchaogeek](https://github.com/ruanyf/weekly/issues/4992) 投稿）

[PasteBar](https://github.com/PasteBar/PasteBarApp)

![](https://cdn.beekka.com/blogimg/asset/202408/bg2024081306.webp)

管理 Mac 和 Windows 剪贴板的免费开源。（[@dllen](https://github.com/ruanyf/weekly/issues/4984) 投稿）
...
一个制作文字徽标（logo 和 favicon）的在线，[代码开源](https://github.com/airyland/logo.surf)。（[@airyland](https://github.com/ruanyf/weekly/issues/4985) 投稿）
...
[CodeBrew](https://apps.apple.com/de/app/codebrew-ide-for-java/id6475267297)
...
一个基于 Web 的开源设计，Figma 的替代品。

[markdown-table](https://josh.fail/2022/pure-bash-markdown-table-generator/)
...
这个可以将输入的图片，使用几何形状重新绘制，参见[作者自述](https://schollz.com/tinker/primitives/)。

[AsmBB](https://asmbb.org/)
...
这个为 Windows 系统提供 Vim 风格的快捷键，也可以把它当作 Windows 的快捷键设定器。
...
这个可以对网页加密，生成一个新网页。打开新网页需要输入一个密码，才能看到内容。
...
一个可视化的 HTML 电子邮件设计，代码开源。类似的还有一个 HTML 邮件制作库 [mjml](https://documentation.mjml.io)。

[hash-wasm](https://github.com/Daninet/hash-wasm)

一个轻量级的哈希函数库，提供了二十几种常见的哈希算法，比如 MD5 和 SHA-1，以及更安全的 BLAKE3。

[Page Replica](https://github.com/html5-ninja/page-replica)

这个开源用来架设一个缓存网站，可以抓取其他网站和网页，建立一个缓存版本，通过它来中介访问。
...
[深蹲计数器](https://github.com/zhaoolee/Sport)
...
[Oceanbase](https://github.com/oceanbase/oceanbase/blob/develop/README_CN.md)
...
[Simple Pastebin](https://github.com/yuxiaoy1/simple-pastebin)
...
[rss2newsletter](https://github.com/ElliotKillick/rss2newsletter)

将 RSS 转换成邮件发送，用于自建邮件列表。

[asciinema](https://github.com/gvcgo/asciinema/blob/main/docs/README_CN.md)

终端录屏 asciinema 的跨平台版本，使用 Go 语言编写。（[@moqsien](https://github.com/ruanyf/weekly/issues/4792) 投稿）

[EcoPaste](https://github.com/ayangweb/EcoPaste)

![](https://cdn.beekka.com/blogimg/asset/202407/bg2024071102.webp)

开源的多平台剪切板管理。（[@ayangweb](https://github.com/ruanyf/weekly/issues/4798) 投稿）

[color4bg.js](https://github.com/winterx/color4bg.js)

![](https://cdn.beekka.com/blogimg/asset/202407/bg2024071103.webp)

生成动态、抽象的背景图的。（[@winterx](https://github.com/ruanyf/weekly/issues/4805) 投稿）
...
一个命令行，可以显示 Git 仓库的详细统计信息，比如代码行数、体积、贡献者等等。
...
一个在线，生成文字分享的卡片图。（[@someone1128](https://github.com/ruanyf/weekly/issues/4737) 投稿）
...
一款 React 框架的无代码/低代码开发，可视化生成网站和应用程序。
...
一个 JS 的 Linter 代码检查，可以取代 ESLint。它是用 Rust 写的，据称比 ESLint 快50-100倍。
...
一个基于 OpenCC 的繁简体中文转换，支持编辑器和命令行界面。（[@hddhyq](https://github.com/ruanyf/weekly/issues/4629) 投稿）
...
[Voicer](https://voicer.hellogeek.work/)
...
一个制作个人手写字体的在线。（[@harbor2009](https://github.com/ruanyf/weekly/issues/4659) 投稿）

[lingo link](https://github.com/chengfengfengwang/lingo-link/blob/main/README_ZH-CN.md)
...
[Best Cookier](https://github.com/Dolov/chrome-best-cookier)
...
[Image Manager](https://github.com/hemengke1997/vscode-image-manager)
...
[Web MediaDevices Player](https://github.com/canwdev/web-mediadevices-player)
...
[LLM 交互式图表](https://columns.ai/chatgpt)
...
一个开源，将不同网络下的多个设备虚拟到一个局域网下，类似与 tailscale、zerotier、n2n。（[@lbl8603](https://github.com/ruanyf/weekly/issues/4444) 投稿）
...
这个网站收集了一些字幕相关的，纯前端处理，无需安装任何插件或软件。（[@mzhren](https://github.com/ruanyf/weekly/issues/4464) 投稿）

[封面图片生成器](https://spacexcode.com/coverview/)

![](https://cdn.beekka.com/blogimg/asset/202405/bg2024051108.webp)

一个制作简单封面图的 Web 。（[@fantingsheng](https://github.com/ruanyf/weekly/issues/4439) 投稿）

另外，还有一个类似的 Logo 制作“[Logo 厨师](https://www.logocook.shop/)”。（[@gdfsdjj145](https://github.com/ruanyf/weekly/issues/4455) 投稿）
...
一个简易的语音箱，提供音频处理、语音识别、合成等音频，使用 Python 语言开发。（[@Hao4Wang](https://github.com/ruanyf/weekly/issues/4471) 投稿）

[Segmentify](https://segmentify.app/zh)
...
一个开源的前端埋点，提供项目监控。（[@M-cheng-web](https://github.com/ruanyf/weekly/issues/4451) 投稿）
...
一个 Web ，用来设计二维码，可以嵌入各种文字和图形，另有一个[类似](http://jsfiddle.net/lachlan/r8qWV/)。
...
Shell 操作历史的搜索，提供神经网络搜索功能，可以替代 ctrl-r 快捷键。
...
一款开源的封面设计，基于 JS 的 Web 应用，有[试用 Demo](https://img-maker.vercel.app/)。（[@slince-zero](https://github.com/ruanyf/weekly/issues/4385) 投稿）

[VideoSubtitleGenerator](https://github.com/buxuku/VideoSubtitleGenerator)

一个命令行，通过语音识别，批量为本地的视频文件生成字幕，并支持翻译。（[@buxuku](https://github.com/ruanyf/weekly/issues/4393) 投稿）

[vmr](https://github.com/gvcgo/version-manager)

![](https://cdn.beekka.com/blogimg/asset/202405/bg2024050401.webp)

一个跨平台的通用版本管理器，目前支持40多种编程语言和。（[@moqsien](https://github.com/ruanyf/weekly/issues/4398) 投稿）

另有一个类似 [vfox](https://github.com/version-fox/vfox)。（[@aooohan](https://github.com/ruanyf/weekly/issues/4233) 投稿）

[Pichome](https://github.com/zyx0814/Pichome)
...
[vue-styled-components](https://github.com/v-vibe/vue-styled-components)

![](https://cdn.beekka.com/blogimg/asset/202405/bg2024050709.webp)

一款类似 styled-components 的 CSS ，支持 vue 3。（[@akinocccc](https://github.com/ruanyf/weekly/issues/4409) 投稿）
...
[豆瓣图书馆查询助手](https://github.com/wyj0605/douban_library)
...
[自律石头](https://apps.apple.com/cn/app/%E8%87%AA%E5%BE%8B%E7%9F%B3%E5%A4%B4-%E8%B5%B0%E8%B7%AF%E8%AF%BB%E4%B9%A6%E6%8D%A2%E6%97%B6%E9%97%B4-%E4%B8%8D%E5%81%9A%E6%89%8B%E6%9C%BA%E6%8E%A7/id6479392365)
...
[音虫](https://www.soundbug.com/)（SoundBug）
...
[极简朋友圈](https://github.com/kingwrcy/moments)
...
[keynavish](https://github.com/lesderid/keynavish)
...
[Segment Anything web UI](https://github.com/Kingfish404/segment-anything-webui)
...
[Notion Flow](https://notion-flow.xheldon.com/)
...
[Side Browser](https://www.sidebrowser.xyz/)
...
[ast-grep VSCode](https://marketplace.visualstudio.com/items?itemName=ast-grep.ast-grep-vscode)
...
[人像生成](https://sinqi.tools/zh/avatar)
...
[SmartExcel.cc](https://github.com/weijunext/smart-excel-ai)
...
[vscode-eslint-disable](https://github.com/lvjiaxuan/vscode-eslint-disable)
...
[FigureToCartoon](https://ai-cartoon-figure.club/home)
...
[ant-codeAI](https://github.com/sparrow-js/ant-codeAI/blob/main/README-zh_CN.md)
...
[Read Copilot](https://apps.apple.com/us/app/read-copilot-beyond-summarizer/id6449242676)
...
[Screenshot Beautifier](https://github.com/CH563/shot-easy-website)
...
[AI 换脸](https://www.changeface.online/)
...
[Vue TSX Admin](https://github.com/manyuemeiquqi/vue-tsx-admin)
...
[mainonly](https://github.com/jerrylususu/mainonly)
...
[ai-teacher](https://github.com/guojingwen/ai-teacher)
...
[Glance](https://github.com/novoselrok/glance)
...
[TwitterShots](https://twittershots.com/)
...
[use autojump in vscode](https://marketplace.visualstudio.com/items?itemName=webxmsj.autojump)
...
[IDP](https://github.com/BaihaiAI/IDP)
...
[Project Shasta](https://pages.adobe.com/shasta/)
...
[Tailwind DX](https://gimli.app/tailwinddx.html)
...
[vagrant-kubernetes-cluster](https://github.com/ameizi/vagrant-kubernetes-cluster)
...
[message-box](https://github.com/kingcc/message-box)
...
[Bash 命令行提示符生成器](http://bashrcgenerator.com/)
...
[Thumbor](https://web.dev/use-thumbor/)
...
[vscode 微信读书插件](https://marketplace.visualstudio.com/items?itemName=goobyter.vscode-weixin-read)
...
[Hubs](https://www.infoq.com/news/2020/05/mozilla-launches-hubs-cloud/)
...
[Boost Note](https://github.com/BoostIO/BoostNote.next)
...
[Edge 浏览器（Chromium 核心）预览版](https://www.microsoft.com/en-us/edge)
...
[YaoYao - 跳绳](https://zhuanlan.zhihu.com/p/86306417)
...
[Basecamp 个人版](https://basecamp.com/personal)
...
[OnChrome](https://github.com/g3rv4/OnChrome)
...
[Code Block Beautifier](https://github.com/Haixiang6123/codeblock-beautifier)
...
[正整数因式分解在线](https://helloacm.com/tools/integer-factor/)
...
腾讯推出的，几行代码就可以为页面加入一个互动社区，可以接入应用程序、小程序、WEB、H5、微信公众号等各端。（@[ifrontend-xyz](https://github.com/ruanyf/weekly/issues/567) 投稿）
...
[Toolmaker](https://github.com/CHCP/toolmaker-docs)
...
[COI - Chat Over IMAP](https://www.coi-dev.org/)（英文）

IMAP 电子邮件协议可以实时推送邮件，COI 就是基于这一点实现的一个聊天协议。通过它的客户端，可以达到聊天效果，但实际是互相发送 Email。

[coderplanets](https://coderplanets.com/home/posts)
...
[Volt](https://volt.ws/)<br /> <br />跨平台的桌面应用，将一些常用服务（比如 Gmail、Slack、Twitter、Facebook 等）聚合在一起。
...
[xs 语言](https://github.com/kulics/xs)
...
[Notebooks\_](https://notebooks.rmotr.com/)
...
[LiteCLI](https://www.pgcli.com/launching-litecli.html)
...
[theme-bmw](https://github.com/dongyuanxin/theme-bmw)
...
[lint-md](https://github.com/hustcc/lint-md)

Markdown 的 lint ，检查编写格式是否规范。（@[hustcc](https://github.com/ruanyf/weekly/issues/98)\_\_ \_\_投稿）

[Get GitHub User's Public Events](https://able8.github.io/github-events/)
...
一个使用 HTML5、CSS、JavaScript 和 Python 开发 Linux 桌面应用的。对的，你不需要 Electron。
