        ...
        <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <div className=" mx-auto mb-3 max-w-screen-sm items-center space-y-4 sm:flex sm:space-y-0">
            <div className="relative w-full">
              ...
              <input
                className=" focus:ring-primary-500 focus:border-primary-500 block h-10 w-full rounded-lg border border-gray-600 bg-gray-700 p-3 pl-10 text-sm text-primary  text-white placeholder:text-gray-400 sm:rounded-none sm:rounded-l-lg"
